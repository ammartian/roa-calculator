...
export interface UseFunnel1CalculatorReturn {
    ...
    results: Funnel1Computation;
    handleReset: () => void;
}

export function useFunnel1Calculator(): UseFunnel1CalculatorReturn {
    ...
    const results: Funnel1Computation = useMemo(() => {
        return computeFunnel1(
