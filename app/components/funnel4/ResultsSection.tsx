...
import type { Funnel4Computation } from "@/lib/funnelBudgetCalculations";
    ...
    return (
        <Card className="border-primary/20 bg-primary/5">
            ...
            <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                    <OutputRow
                        label={t.premiumCustomers}
                        value={formatQuantity(results.premiumCustomers, isValid)}
                    />
                    <OutputRow
                    ...
                    />
                    <OutputRow
                        label={t.upfrontSales}
                        value={
                            isValid ? formatRinggit(results.upfrontSales) : "—"
                        }
                    />
                    <OutputRow
                        label={t.totalSales}
                        value={
                            isValid ? formatRinggit(results.totalSales) : "—"
                        }
                    />
                    <OutputRow
                        label={t.grossProfitPerCustomer}
                        value={
                            isValid
                                ? formatRinggit(results.grossProfitPerCustomer)
                                : "—"
                        }
                    />
                    <OutputRow
