...
import type { Funnel6Computation } from "@/lib/funnelBudgetCalculations";
        ...
        <Card className="border-primary/20 bg-primary/5">
            ...
            <CardContent className="space-y-4">
                ...
                <div className="space-y-2">
                    ...
                    />
                    <OutputRow
                        label={t.appointmentsNeeded}
                        value={formatQuantity(results.appointmentsNeeded, isValid)}
                    />
                    <OutputRow
                        label={t.leadsNeeded}
                        value={formatQuantity(results.leadsNeeded, isValid)}
                    />
                    <OutputRow
